...
class CustomQuoteTemplateDoc(models.Model):
    ...
    _description = "Default quotation documents for a template"
    _order = "sequence, id"
    ...
    _sql_constraints = [
        ("template_document_uniq", "unique(template_id, document_id)",
...
class SaleOrderTemplate(models.Model):
    ...
    custom_template_doc_ids = fields.One2many(
        "custom.quote.template.doc", "template_id", string="Documentos por defecto"
    )
